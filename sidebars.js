...
// Section sidebars. Each backs one navbar tab (docusaurus.config.js, type: docSidebar),
// so the active tab follows the page's sidebar. Every listed doc belongs to exactly
// one sidebar; scripts/sidebar-coverage.mjs enforces that at the gate. Doc IDs and
// slugs never change here, so moving items between sidebars cannot move a URL.
...
const sidebars = {
      ...
      items: [
        ...
        "how-to/enforce-permissions/data-filtering",
        {
          ...
          items: [
            ...
            "how-to/enforce-permissions/url-mapping/fetching-jwks",
            "how-to/enforce-permissions/url-mapping/configuring-jwks",
          ],
        },
        {
          type: "category",
        ...
        },
        {
          type: "doc",
          label: "Frontend",
          id: "integrations/feature-flagging/casl",
        },
        {
          // The PDP overview lives in the concepts sidebar; linked here, not listed twice.
          type: "link",
  ...
  aiAgents: [
    // The gateway is the entry point most readers want first: it is the
    // product they deploy in front of their MCP servers.
    {
      type: "category",
      ...
      items: [
        {
          ...
          items: [
            ...
            "how-to/deploy/overview",
            {
              ...
              link: {
                type: "generated-index",
                slug: "/category/on-prem",
              },
              items: [
                {
                  type: "autogenerated",
                  dirName: "how-to/deploy/on-prem",
                },
              ],
            },
            {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                {
                  type: "autogenerated",
                  dirName: "how-to/use-audit-logs/errors",
                },
              ],
            },
            "api/pdp-webhooks",
