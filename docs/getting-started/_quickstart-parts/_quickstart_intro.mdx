...
or as a managed Cloud PDP that Permit.io runs for you.

<Tabs groupId="pdp">
<TabItem value="cloud" label="Cloud PDP" default>

Cloud PDP is easy to use. As part of the initialization of the Permit instance, you just need to pass
the Cloud PDP URL.
