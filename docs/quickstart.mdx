...
SSO is provided as the default option in [Permit’s Enterprise Tier](https://www.permit.io/pricing), or as a standalone option at a yearly
defined rate.
...
:::note
The new user will be created in the tenant we are currently working in. If you want to create a user in a different tenant,
you can switch the tenant in the "Tenant" dropdown.
:::
...
- Building policies
  - [Using Roles (RBAC)](/how-to/build-policies/rbac/overview)
  - [Using Attributes (ABAC)](/how-to/build-policies/abac/overview)
  - [Using Relationships (ReBAC)](/how-to/build-policies/rebac/overview)
  - [Using Policy as Code (PBAC)](/integrations/gitops/custom_policy)
- [Sync Users to Permit](/how-to/sync-users)
- [Enforcing Permissions](/how-to/enforce-permissions/check)
- [Using Audit Logs](/how-to/use-audit-logs/types-and-filtering)
- [Loading Custom Data](/how-to/manage-data/loading-data)
- [Deploying to Production](/how-to/deploy/deploy-to-production)
