---
sidebar_position: 1
title: Google Drive (Zanzibar)
description: "Model a simplified Google Drive-like permission system using ReBAC with the Permit.io SDKs or API."
---
...
This tutorial explains how to build a simplified [Google Drive](https://www.google.com/drive/)-like permission system using [Permit.io](https://www.permit.io).

## Before you begin

1. [Sign up to Permit.io](/quickstart#1-create-a-permit-account)
2. [Get your environment API Key](/overview/connecting-your-app#1-get-your-permit-environment-api-key)
...
The API key you should use for your API calls must be an [environment-level API key](/overview/connecting-your-app#1-get-your-permit-environment-api-key).
  </TabItem>
</Tabs>
...
- **Resource Roles** are denoted by <span className="text-[#2563eb] dark:text-[#5b86f2]">blue circles</span>
