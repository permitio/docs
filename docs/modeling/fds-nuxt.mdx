...
Unlike B2B SaaS applications that sometimes go all the way with fewer users and roles, consumer applications always grow fast in users and permissions. They also require fine-grained authorization that performs at scale.
