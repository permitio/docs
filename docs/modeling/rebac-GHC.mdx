...
description: "Explore Galactic Health Corporation, a healthcare demo app that models RBAC, ABAC, and ReBAC policies with Permit.io."
---
...
- Role Derivations - ReBAC allows us to derive authorization policies based on existing application-level relationships. Put in the simplest way, permissions can be derived from the Member Profile to the Medical Record.
