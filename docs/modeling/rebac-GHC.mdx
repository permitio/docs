...
As the decision point is up and running, open a new terminal window in the root folder of the repository and run `npm run dev`. This will start the application locally, and you can access it at http://localhost:3000.
