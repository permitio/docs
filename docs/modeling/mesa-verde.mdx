...
description: "Explore Mesa Verde, a fintech demo app that models multi-tenant RBAC and secure collaboration flows with Permit.io."
---
...
At this point, we are done with our RBAC policy. We have the resources, the top-level roles, and the policy rules resulting from them. Now, let's continue with creating sets of users that will allow us to create ABAC policies.
