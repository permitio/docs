...
<<<<<<< HEAD
Permit provides a strict separation between the **Control Plane** (where policies are managed) and the **Data Plane** (where
authorization decisions are enforced). This architecture improves security, scalability, and compliance.
=======
Permit provides a strict separation between the centralized **Control Plane** (where policies are managed) and the distributed **Data Plane** (where authorization decisions are enforced). This architecture improves security, scalability, and compliance.
>>>>>>> 2193628439329fba689436431d5b5781d88effb3
