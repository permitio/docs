...
Data changes tracked by Permit.io are propagated to the specific PDP shard that is responsible for assocaited with them. The same consistent hashing algorithm will be used to map the data to the correct shard.
