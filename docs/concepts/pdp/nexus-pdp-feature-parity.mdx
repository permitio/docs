...
Capability-by-capability comparison between the [container PDP](/concepts/pdp/overview#run-an-edge-pdp-with-docker) (`permitio/pdp-v2`) and the [Nexus PDP](./nexus-pdp) (`permitio/pdp-v3`).
