...
description: "Configure the PDP with environment variables, including OPAL- and PDP-prefixed settings such as the API key."
---
...
_Added in PDP v0.9.0<br /> use UVICORN_PORT for PDP versions prior to v0.9.0_
...
The timeout for querying OPA for an allow decision, in seconds. 
Version 0.8.x and below:  `0` means no timeout.
Version 0.9.0 and above: `0` means 0 seconds. 
