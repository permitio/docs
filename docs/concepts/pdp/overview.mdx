...
sidebar_position: 1
title: Overview
description: "What the Permit.io policy decision point (PDP) is, how the managed Cloud PDP and self-hosted Edge PDPs differ, and how to deploy and run them."
---
...
A third option, [**Nexus PDP**](/concepts/pdp/nexus-pdp), is a self-hosted PDP with an embedded on-disk database, built for large data sets and high request rates.
