...
Permit's PDP supports the [OpenID AuthZen Authorization API 1.0](https://openid.github.io/authzen/) specification, providing a standardized way for Policy Enforcement Points (PEPs) to communicate with Policy Decision Points (PDPs). 
