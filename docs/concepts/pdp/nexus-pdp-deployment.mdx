---
title: Nexus PDP — Deployment
sidebar_label: Deployment
description: Deployment requirements, health and readiness probes, logging, and the security model for the Nexus PDP.
sidebar_position: 5
---

# Deploying the Nexus PDP

Operational requirements, observability surfaces, and the security model for the [Nexus PDP](./nexus-pdp.mdx).

---

## Deployment requirements

The Nexus PDP has real operational requirements that the container PDP does not. Read these before deploying.
...
**Memory: start at 4 GiB.** See [Resource footprint](./nexus-pdp-how-it-works.mdx#resource-footprint) for tuning.
