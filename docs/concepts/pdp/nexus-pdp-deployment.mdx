...
Operational requirements, observability surfaces, and the security model for the [Nexus PDP](./nexus-pdp).
...
**Memory: start at 4 GiB.** See [Resource footprint](./nexus-pdp-how-it-works#resource-footprint) for tuning.
