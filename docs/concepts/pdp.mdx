...
You can set this env var `PDP_ALLOW_METRICS_UNAUTHENTICATED` to true to allow access to the PDP metrics without authentication (can be used for monitoring tools like DataDog etc) - supported from version 0.2.27.
