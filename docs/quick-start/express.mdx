...
At the end of `server.js`, start the server with `app.listen(port)`. Then set the environment variables and start the app, replacing `<YOUR_API_KEY>` with your API key:
