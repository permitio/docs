...
description: "Add fine-grained authorization to a Spring Boot application with Permit.io, from policy setup to role assignment and enforcement."
sidebar_position: 8
---
...
Before integrating Permit.io with your Spring Boot application, you need to configure a policy. If you already have a policy configured, you can skip this section and proceed directly to the [integration guide](#integration-guide).
...
- [Java SDK Documentation](/sdk/java/quickstart-java) - Explore advanced features and API methods
