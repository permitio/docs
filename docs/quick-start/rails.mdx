...
| Action | What it does |
|---|---|
| `register` | Syncs the user to Permit.io with the email address as the user key, then assigns the **Reader** role in the `default` tenant. Returns `201` with the user and the role assignment. |
