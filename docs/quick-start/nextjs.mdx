...
Once you have a Next.js application set up, we can integrate Permit.io with it. First, we need to install the Permit SDK. To install the SDK, execute the command below in your terminal.
...
It's that easy to add roles and permissions using the dashboard. We can also add more roles and resources as per our needs.
