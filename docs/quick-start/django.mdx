...
- Python 3 with [Django](https://www.djangoproject.com) 5.0 or later installed, and a Django project named `permit_demo`. To create the project, run `django-admin startproject permit_demo`.
