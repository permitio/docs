...
Instead, you should use the **[assignRole](/2.0.0/sdk/nodejs/role/assign-role)** function.
...
`email` - **optional** - The email of the user. If synced, will be unique inside the environment.<br/><br/>
`first_name` - **optional** - First name of the user.<br/><br/>
`last_name` - **optional** - Last name of the user.<br/><br/>
...
```js
const user = await permit.api.syncUser(${JSON.stringify(user)});
```
