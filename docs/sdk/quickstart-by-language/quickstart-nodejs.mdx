...
:::tip
When working with ABAC (Attribute-based Access Control), for the `user` and `resource`, you can pass an object containing
attributes that you are looking to match against. If you want to understand permission ABAC checks better, please refer to
[this guide](/how-to/enforce-permissions/check#attributes).
:::
