...
Working with the Permit.io [Insert Language Here] SDK enables developers to seamlessly integrate robust authorization management into
...
- `user`: a unique string id that identifies the user performing the action.
...
:::note
For a comprehensive overview of basic SDK functionality, please refer to the [compatibility list](/sdk/sdks-overview) of SDK
functions available per language.
:::

## Working with the full SDK specification

Congratulations on completing the quickstart guide for [Language] SDK! By now, you should have a solid understanding of the basics,
including setting up your environment, making your first API calls, and handling common tasks.

To further enhance your skills and explore the full capabilities of the [Language] SDK, we highly recommend referring to the
comprehensive [Language] SDK [reference documentation](https://permitio.github.io/permit-node/classes/Permit.html). There, you will
