---
description: "Update a resource's name, description, actions, or attributes with the Go SDK."
---
...
`Description` - **optional** - An optional longer description of what this resource represents in your system.<br/>
