...
1. To find detailed instructions on how to fetch the JWKS, refer to the corresponding guide provided by your authentication provider.
   You can find a summary for the mosty popular authentication porvider [here](/frontend-only-authz/fetching-jwks).

2. [Configure](/frontend-only-authz/configuring-jwks) your JWKS with Permit, so it will be able to verify your user JWTs for you.
