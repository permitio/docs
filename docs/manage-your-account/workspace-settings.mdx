...
Permit offers a standard [Data Processing Addendum](https://www.permit.io/legal/data-processing-addendum) that you can review and adopt immediately. Enterprise and Pro (for an additional fee) customers can request a tailored DPA by contacting support or their customer success manager.

You are never required to store personally identifiable information (PII) inside Permit’s control plane. You can rely entirely on opaque user identifiers, and if you must work with PII you can keep it solely on your self-hosted PDPs.
