...
:::note Info
Currently, Policy Guards are only available trough the [Permit API](/manage-your-account/policy-guard/policy_guard_api).
The Policy Guard UI is coming soon.
:::
...
Also, Policy Guards are only available for RBAC (Role-Based Access Control) and ABAC (Attribute-Based Access Control) policies, ReBAC (Relationship-Based Access Control) support is coming soon.
:::
