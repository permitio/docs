...
You can enable or disable default role creation using the toggle button in the **policy editor settings**. Visit the settings button in the **[policy editor](https://app.permit.io/policy-editor)** section to access this toggle. This toggle allows you to control automatic creation of default roles and actions:
