...
- A `name` - name of the Proxy Config object
- A`key` - key of the Proxy Config object (used to identify the object in Permit.io API)
- A`mapping_rules` - array of mapping rules (see below)
