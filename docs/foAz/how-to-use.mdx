...
These attributes will be replaced with the values from the request that is sent to the Permit.io Proxy component, and will be covered in the [Calling FoAz API from your frontend](/foAz/how-to-use#calling-foaz-api-from-your-frontend) section.
