...
skip to the Setup Basic Role Based Authorization section
:::
...
3.  In the Permit Dashboard, go to the Audit Log tab in the left sidebar. You should see that he 'post' action was logged.
    ...
    Allow will qual to true as this user has the User role.
