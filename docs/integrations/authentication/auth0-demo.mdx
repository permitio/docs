---
sidebar_position: 2
title: Auth0 x Permit Demo application explanation
---

## 1. Demo application explanation
### 1.1. The application
...
You could find the full code of the demo application [here](https://github.com/permitio/permit-next-todo-starter/tree/auth0-integration)
