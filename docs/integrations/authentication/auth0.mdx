...
### 3.1. Auth0
As we want to use Auth0 for authentication, so we will use the Auth0 SDK to get the user's information and to get the user's access token.
