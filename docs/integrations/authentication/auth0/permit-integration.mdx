...
- An application that uses Auth0 for authentication; in this example, we will use a NextJS app [Check out the demo explanation for more details](/integrations/authentication/auth0/auth0-demo-app).
