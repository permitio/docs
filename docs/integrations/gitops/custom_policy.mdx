...
description: "Extend Permit's GitOps-generated policy with custom Rego code, such as a deny rule that overrides other access policies."
---
...
Permit.io supports two open-source policy engines: OPA, and Cedar to keep policy configuration flexible.
