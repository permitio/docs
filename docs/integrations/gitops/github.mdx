---
sidebar_position: 2
title: GitHub x Permit
---

#### Other Git repositories

This guide is focused on Github repositories, but should work in a similar fashion to other Git repositories which can be configured with an SSH key.
