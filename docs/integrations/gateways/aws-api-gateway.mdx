...
![API Gateway Create authorizer form with the Lambda type, the permit-check function, the Request payload, and a header identity source](/img/integrations/aws/aws-5.png)
