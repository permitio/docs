...
sidebar_position: 1
title: Overview
description: "Enforce permissions on a GraphQL API with Permit by mapping resources and actions in resolvers, schema directives, data sources, or middleware."
---
...
Check out [this tutorial](/integrations/GraphQL/apollo_server) for an implementation of plugin approach for [Apollo Server](https://www.apollographql.com/docs/apollo-server/).
