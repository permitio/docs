...
sidebar_position: 2
title: Apollo Server
description: "Add Permit permission checks to an Apollo Server GraphQL API by mapping operation names to resources and actions in a server plugin."
---
...
```
#### 4 (option 1) - Operation name to resource & action mapping
