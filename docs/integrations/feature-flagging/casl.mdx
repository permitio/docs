...
sidebar_position: 1
title: CASL
description: "Integrate CASL with Permit using the permit-fe-sdk to control frontend feature flags in a React or Next.js app based on RBAC and ABAC permissions."
---
...
::::danger be careful
If you are using Cloud PDP for running your Permit checks, please be aware that Cloud PDP supports **RBAC and ReBAC** only.
**ABAC is not supported on Cloud PDP**. ABAC policies (adding extra user and resource attributes) require using a container PDP.
