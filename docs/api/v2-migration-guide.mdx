...
description: "Migrate from the Permit v1 API to v2: what changed in the object hierarchy, schema and facts objects, and SDK writes."
---
...
If you want to fetch all Organization-scoped objects through the REST API, using your Organization-global API key make calls to:
