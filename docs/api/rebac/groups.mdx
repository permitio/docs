...
:::tip Performance-Optimized Endpoints
The Groups API has been updated with new, performance-optimized endpoints. See the [Additional API Operations](#additional-api-operations) section for the latest recommended methods. Previous GET endpoints are considered deprecated in favor of these improved alternatives. They should not be used and will be removed in the future.
:::
