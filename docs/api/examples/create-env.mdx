...
Environment is a logical grouping of your users and their roles. You can create multiple environments for your project. For example, you can create a `production` environment for your production users and a `staging` environment for your staging users. You can also create a `test` environment for your test users. You can create as many environments as you want for your project.
...
:::warning Remember
Make sure you use organization level api key or project level api key to create a new environment.
:::


But before we need to get our `API_SECRET_KEY` from the dashboard and get current `project_id`<br/>
