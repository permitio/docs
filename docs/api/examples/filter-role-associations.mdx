...
using the `attr_` prefix. This feature enables you to retrieve only the roles that match specific attribute values.

### Example

To filter roles by attributes in your project, you can make a GET request to the following endpoint:
