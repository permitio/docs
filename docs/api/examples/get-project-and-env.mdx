...
For many of the API calls, you will need to know the project id and environment id. This page will show you how to get those values.
...
Make sure you copied API_SECRET_KEY that belong to an environment that is under the project you want to get the id for.

### Get Project object from the API
...
You can take either the `id` or `key` from the project object.

## Get Environment id or key

Use the same API_SECRET_KEY you used to get the project id or key.<br/>
Use the project id or key you got from the previous step.<br/>

### Get Environment object from the API
...
You can take either the `id` or `key` from the environment object.