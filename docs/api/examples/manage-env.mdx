...
you can update the environment settings using the [update environment settings](https://api.permit.io/v2/redoc#tag/Environments/operation/update_environment) endpoint.
