...
:::tip Supported objects
Copy Environment currently copies the following objects:
 - Resource, including actions and attributes
 - Roles
 - Resource and User sets

There is limited support currently for ReBAC objects including relations and resource roles.
:::
