...
:::note
When creating a new environment from the dashboard, the settings will be configured to the default values.
...
you can activate the Policy Repo by following the following [guide](/integrations/gitops/github#make-permit-use-the-repository).
