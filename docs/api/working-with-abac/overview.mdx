...
sidebar_position: 1
title: Overview
description: "Learn ABAC API concepts: condition sets, condition set rules, and how to send API requests with project and environment IDs."
---

## Overview

The API now allows us to create **[ABAC](/how-to/build-policies/abac/overview)** calls, which give much more flexibility when defining
...
With the functionality of ABAC, we can now define **[Condition Set Rules](./condition-set-rules.mdx)** that will be part of **[Condition Sets](./condition-sets.mdx)** - but before we dive
