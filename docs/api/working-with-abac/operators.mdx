...
sidebar_position: 2
title: Operators
description: "Reference for the logical and comparison operators, including reference operators, used to build ABAC conditions."
---
...
Now that we have a basic understanding of the language to construct conditions, lets jump into creating **[Condition Sets](./condition-sets.mdx)**.
