...
We have now successfully defined two condition sets. Let's learn how we can use them together and create a **[docs/api/working-with-abac/condition-set-rules.mdx](condition-set-rules)**.
