---
sidebar_position: 9
title: Access Request API- Backend Only
---
...
# Access Request- Use API KEY for Backend Only

:::info
This API is designed for use with the access request feature via the API only. If you are using access requests as part of Permit Elements, you should use the [Access Request Element](/api/elements/access-requests) instead.
:::
