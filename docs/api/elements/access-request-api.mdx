---
sidebar_position: 9
title: Access Request- Use API Only
---
...
This API is designed for use with the access request feature via the API only. If you are using access requests as part of Permit Elements, you should use the [Access Request Element](/embeddable-uis/element/access-request) instead.
