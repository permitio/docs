...
This API is designed for use with the access request feature via the API only. If you are using access requests as part of Permit Elements, you should use the [Access Request Element](/elements/access-requests) instead.
