---
description: "Run a PDP container, check permissions, view PDP stats, and check URL-based permissions from the CLI."
---
...
Use this command to run a Permit PDP Docker container configured with your [Permit.io](https://www.permit.io/) account details. The command will start the container in detached mode and display the container ID and name.
