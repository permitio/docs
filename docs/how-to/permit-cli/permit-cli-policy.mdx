...
description: "Create policies from the CLI with a simple wizard, natural language AI, templates, or an OpenAPI spec."
sidebar_position: 5
---
...
- `resources <string[]>` (Optional) : Array of resources in the format: "key:name@attribute1,attribute2"
  ...
  - `@attribute1,attribute2` : comma-separated list of attributes.
...
If you approve the policy, the CLI will apply the policy to your [Permit.io](https://www.permit.io/) environment, creating all the resources, roles, and permissions defined in the policy.
