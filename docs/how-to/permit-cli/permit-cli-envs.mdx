...
description: "Create, copy, delete, and manage Permit environments from the CLI, and export environment configuration to Terraform."
sidebar_position: 2
---
...
> :bulb: Note: **Use with caution: this operation cannot be undone.**
...
This command will assign members to an environment with the roles you specify. This is useful for managing the access control of your team members in the [Permit.io](https://www.permit.io/) environment.
...
This command lets you select a different active [Permit.io](https://www.permit.io/) environment. This is useful when you have multiple environments in your account and want to switch between them without logging out and logging in again.
