...
description: "Manage Policy Guard scopes, project associations, and permission rules across projects with the Policy Guard API."
---
...
For example, if you will try to create rule with user set and role key, it will throw an error.
:::
