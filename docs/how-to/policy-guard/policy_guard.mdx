...
sidebar_position: 1
title: Policy Guard
description: "Learn how Policy Guards centrally enforce RBAC and ABAC permission rules across multiple projects in an organization."
---
...
A Policy Guard is a feature that allows you to define and enforce specific permissions for different roles across multiple projects.
...
:::note Info
Currently, Policy Guards are accessible only via the [Permit API](/how-to/policy-guard/policy_guard_api).
The Policy Guard UI is on the roadmap, message us in [our slack channel](http://io.permit.io/slack) `#early-access-program` to get early access yourself.
:::
