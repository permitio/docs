...
description: "Map Permit's Application, Configuration, Data, and Enforcement planes to your software development life cycle."
...
[Permit](https://www.permit.io/) components should be incorporated into your SDLC. This step is critical because it helps create a clear
...
These planes—**Application**, **Configuration**, **Data**, and **Enforcement**—serve different functions,
...
As with the application plane, at [Permit.io](https://www.permit.io/), we tried to enable developers to adopt the method that best fits their workflow.
