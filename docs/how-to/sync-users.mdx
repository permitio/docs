...
A detailed explanation of how to use the `syncUser` function with each of our SDKs [is available here](/category/-sdks). The `syncUser` function will consist of:
