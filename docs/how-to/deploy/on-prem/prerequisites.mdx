  ...
  <div className="flex">
    <div className="ml-3">
      <p className="text-sm text-blue-700">
        <strong>Important:</strong> The Permit Platform installer is designed to be self-contained and handles most setup automatically. You only need to meet basic system requirements and configure Git integration (required).
      </p>
    </div>
  </div>
</div>
