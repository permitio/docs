...
### When to Use --skip-images Flag

**Use `--skip-images` when:**
- ✅ Images are already pushed to your private registry (GKE/GAR, Artifactory, Harbor, ECR, ACR)
- ✅ Re-running installation after initial image load
- ✅ Testing Helm chart changes without reloading images

**Do NOT use `--skip-images` when:**
- ❌ First-time installation from tar.gz package
- ❌ Images need to be loaded to Docker daemon (Kind clusters)
- ❌ Using Docker Hub and images aren't pre-loaded
...
**Need help?** Contact support@permit.io with your diagnostic bundle and system information, or [join our Slack community](https://io.permit.io/slack).