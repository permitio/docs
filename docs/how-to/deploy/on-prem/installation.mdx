  ...
  <div className="flex">
    <div className="ml-3">
      <p className="text-sm text-blue-700">
        <strong>Prerequisites required:</strong> Make sure you've completed the <a href="../prerequisites" className="underline">prerequisites setup</a> before starting.
      </p>
    </div>
  </div>
</div>
...
**Installation complete?** Continue to [Management Guide](../management) to learn about day-to-day operations.