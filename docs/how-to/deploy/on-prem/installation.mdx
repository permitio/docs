...
- ✅ **Policy Sync configuration** - Validates Git repository URL and SSH private key format
...
[INFO]   • OpenSearch Dashboard: https://permit-platform.local/opensearch/ (no authentication required)
[INFO]   • RabbitMQ Dashboard: https://permit-platform.local/rabbitmq/ (permit/[Generated Password])
[INFO]   • Keycloak Admin: https://permit-platform.local/auth (admin/[Same Admin Password])
[INFO]   • SCIM Service: https://permit-platform.local/scim
[INFO] Important:
