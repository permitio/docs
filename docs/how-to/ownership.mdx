...
Ownership is the first building block of fine-grained authorization. As we always want first to ensure data owned by a user is accessible to them and to those given the privilege by them.
