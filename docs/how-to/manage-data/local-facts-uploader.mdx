...
You can translate requests to the Permit API to use Proxy Facts by translating the URL path from `https://api.permit.io/v2/facts/{proj}/{env}/...` to `http://localhost:7766/facts/...`.
