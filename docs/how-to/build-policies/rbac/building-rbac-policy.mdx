...
description: "Build an RBAC policy in Permit by creating roles, defining a resource, assigning permissions, and adding users."
---
...
To achieve more granularity in role creation, we
