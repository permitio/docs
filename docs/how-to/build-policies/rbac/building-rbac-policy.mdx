...
### Creating roles (Top Level)

As part of the RBAC Policy, we need to create specific roles (Top Level) that will be assigned specific permissions.
We are going to create two roles; an **admin** and a **customer**.

#### Creating the Admin Role (Top Level) within the UI

[//]: # (todo change all imges in page)
