...
sidebar_position: 2
title: Components
description: "Learn the roles, resources, and actions that make up an RBAC policy, with a simple example and interactive demo."
---
...
**Role** ([Top Level in the UI](/how-to/build-policies/rbac/components/#keyword-definitions)) - the action and responsibilities that a particular person has,
Top level represents the fact that Roles have higher priority in policy evaluation than Instance-level Roles. <br />
...
:::tip
When creating an RBAC policy within the UI, every **resource** and **action** will get **inherited** by any other role ([Top Level in the UI](/how-to/build-policies/rbac/components/#keyword-definitions))
you decide to add.
:::
