...
**Role** (**Top Level** in the UI) - the action and responsibilities that a particular person has.<br />
...
:::tip
When creating an RBAC policy within the UI, every **resource** and **action** will get **inherited** by any other role (top level)
you decide to add.
:::
