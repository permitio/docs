...
- ### Ownership via list on resource
  ...
  Use a [dynamic resource (resource-set)](/how-to/build-policies/abac/building-abac-policy#step-5-defining-resource-sets) to check against the list.
...
- ### Ownership via list on user profile
  ...
  Use a [user-set](/how-to/build-policies/abac/building-abac-policy#step-3-defining-user-sets) to check against the list.
