...
description: "Configure temporary, time-based role assignments in Permit using ABAC condition sets and expiring tenant attributes."
---
...
- A [Permit.io](https://www.permit.io) account.
- A **role** called `admin`.
