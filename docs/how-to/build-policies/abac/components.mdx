...
sidebar_position: 2
title: Components
description: "Review the four ABAC components, subject, resource, action, and environment attributes, through a worked example."
---
...
### [Subject & Subject Attributes](./building-abac-policy.mdx#step-1-creating-user-attributes)
...
### [Resource & Resource Attributes](./building-abac-policy.mdx#step-4-creating-resources)
...
### [Action](./building-abac-policy.mdx#step-6-applying-permissions)
