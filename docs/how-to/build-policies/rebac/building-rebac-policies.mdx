...
#### Connecting resource instances wih a relationship 
Say you want to place a specifc document under a specifc folder you can do so via the Permit `Directory` under the `instances` tab.
