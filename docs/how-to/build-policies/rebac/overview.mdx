...
Extanding on [RBAC](https://docs.permit.io/how-to/build-policies/rbac/overview), ReBAC considers the relationships between identities and resources,
...
:::tipExample
The simplest example for ReBAC is a shared file system (e.g. [Google Drive](https://docs.permit.io/modeling/google-drive)).
