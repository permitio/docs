...
By default, every new resource will have default roles assigned to it: Admin, Editor, and Viewer.
These roles come with default actions (if they exist in the resource action). You can edit the default roles and actions based on your needs.
To disable "Assign the Default Roles to every new resource," visit the **[advanced settings](https://app.permit.io/settings/advanced)** section.
