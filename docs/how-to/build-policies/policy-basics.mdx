...
There are three types of policies that we currently support:

1.  **[RBAC (Role-based Access Control)](/how-to/build-policies/rbac/overview)**
2.  **[ABAC (Attribute-based Access Control)](/how-to/build-policies/abac/overview)**
3.  **[ReBAC (Relationship-based Access Control)](/how-to/build-policies/rebac/overview)**
...
Roles are assigned to users via the **[User Management](/features/user-management)** page.
...
_Above is a User Management example with three users - **Gandalf**, **Frodo** and **Gollum**, all residing in the **default** tenant_.
...
It's important to notice, that a user within each tenant can have different roles assigned, which of course,
...
**Rego** or **Cedar** code you generate into a git repository of your choice.
