...
checked within a given month. Regardless of the number of permission checks performed for a user per month, they are counted as a
...
[Bulk synchronization](https://docs.permit.io/how-to/bulk-operations#bulk-user-operations) involves uploading a large number of user identities to Permit.io in a single operation.
