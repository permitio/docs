...
There are limits on the overall data volume that can be loaded to a single PDP, which can be bypassed via [PDP Sharding](https://docs.permit.io/how-to/manage-data/pdp-sharding/).
:::
