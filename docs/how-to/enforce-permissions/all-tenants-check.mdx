...
description: "Check a user's permissions for an action across all tenants with permit.AllTenantsCheck()."
---
...
The `permit.AllTenantsCheck` function accepts an [individual check requests](./check.mdx) as input.
