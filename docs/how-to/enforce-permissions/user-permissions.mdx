...
description: "Get a user's permissions across all tenants, including ABAC-based access, with permit.GetUserPermissions()."
---
...
:::note
`enable_abac_user_permissions` parameter name is subject to change. Make sure to verify that the name remains accurate. 
:::
