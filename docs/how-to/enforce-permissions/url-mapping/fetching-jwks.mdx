...
sidebar_position: 3
title: Fetching JWKs
description: "Fetch JSON Web Key Sets (JWKS) from providers like Auth0, Okta, AWS Cognito, Clerk, OneLogin, and SuperTokens."
---
...
to the server in which you have initialised SuperTokens using our backend SDK.
