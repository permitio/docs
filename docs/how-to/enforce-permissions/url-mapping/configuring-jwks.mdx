...
description: "Add your obtained JWKS to a Permit environment through the dashboard's JWKS Config settings."
---
...
![Navigating to Settings](/img/url-mapping/settings.png)

#### 2. Click on the JWKS Config

![JWKS Config](/img/url-mapping/jwks-config.png)

#### 3. Select the environment you want to configure and add your JWKs

![Select Environment](/img/url-mapping/select-env.png)
...
![JSON Editor](/img/url-mapping/json-editor.png)
