...
Permit's Debug Mode adds additional debug information to your decision logs, allowing for an in-depth analysis of the decisions made by your [PDP](link).
...
- Which policy was taken in consideration for the evaluation process
- What are the policies currently configured in your environment

This information gives you more granular understanding of any decision made by the PDP.
...
When runing your PDP, set the environment variable `PDP_DEBUG=True` as part of the PDP deployment.
