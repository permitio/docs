...
sidebar_position: 3
title: Debug Mode
description: "Enable Debug Mode on the PDP or via the API to add decision-making detail to your audit logs."
---


Knowing why some decisions were made by your PDP can be a crucial part of building and understanding your policies, especially when you encounter unexpected results.
