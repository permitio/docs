...
description: "Fix the resource action not found error by adding the missing action to the resource in Permit."
---
...
- [Java SDK](/sdk/java/resource/update)
- [Go SDK](/sdk/golang/resource/Update)
