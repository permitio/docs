...
As part of the [Quickstart guide](/getting-started/), you need to [run the PDP](/getting-started/quickstart#2-run-the-container) with the right environment key. Make sure you are using the right key for the environment
you are running in.
