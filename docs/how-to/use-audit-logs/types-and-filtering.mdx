...
We periodically delete old audit logs to maintain system efficiency. If you need access to older logs or would like to extend log retention periods for your account, please reach out to us via [Slack](io.permit.io/slack) or email us at [help@permit.io](mailto:help@permit.io).
:::
