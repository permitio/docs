...
We periodically delete old audit logs to maintain system efficiency. If you need access to older logs, please reach out to us via Slack or email us at [help@permit.io](mailto:help@permit.io). We also offer plans for extended audit log retention. For more details, contact us directly.
:::
