...
description: "Forward PDP decision logs to Elasticsearch or stdout with the FluentBit-based Permit Logs Forwarder."
---
...
1. Switch ```pdp.logs_forwarder.enabled``` to ```true```.
