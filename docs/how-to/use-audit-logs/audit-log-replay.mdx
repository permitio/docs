...
description: "Replay past permit.check() requests against a PDP with the Audit Log Replay API to load test or debug policy changes."
...
- [Audit Logs Overview](./types-and-filtering.mdx)
- [Troubleshooting with Audit Logs](./troubleshooting.mdx)
- [PDP Configuration](../../concepts/pdp/configuration.mdx)
