...
### 1. Via the API using the [Copy env](https://api.permit.io/v2/redoc#tag/Environments/operation/copy_environment) option
...
### 2. Via the [Terraform Provider](/integrations/infra-as-code/terraform-provider)
...
### 3. Via [Gitops](/integrations/gitops/overview)
