...
### Do you guys have a timeline on supporting Golang?

We aim to release Golang support in the coming weeks (Q1 of 2023). If you ever need an SDK for a language that we do not currently support, you can go ahead and generate your own using the Open-API / swagger spec, as both the PDP and API provide this.
