...
These instructions apply to Azure Active Directory (Microsoft Entra ID) and Azure AD B2C. While not explicitly tested, Azure AD is SAML 2.0 compliant and should work with Permit.io's implementation.
:::
...
**Solution:**
- Go to Azure AD app → **Single sign-on** → **Attributes & Claims**
...
**Solution:**
- Go to Azure AD app → **Users and groups**
...
1. Go to your Azure AD application → **Properties**
