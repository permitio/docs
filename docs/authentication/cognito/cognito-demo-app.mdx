...
If you want to add roles to the user, use the `permit.api.assignRoles(userKey, roleKey, tenantKey)` [function](https://docs.permit.io/sdk/nodejs/role/assign-role/). 
