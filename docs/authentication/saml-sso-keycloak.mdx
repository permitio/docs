...
- **Sign documents**: **ON**
- **Sign assertions**: **ON**
- **Client signature required**: **OFF** ⚠️ **Important - must be OFF**
...
1. Go back to your client → **Client scopes** tab
...
**Solution:**
- Go to your client → **Client scopes** → **role_list (saml)** → **Mappers** → **role list**
