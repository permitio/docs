...
3. **Your Permit.io Organization ID** - found in Permit.io → Settings → Organization
...
See [integration examples](/authentication/saml-sso-integration) for Next.js, Vue.js, and backend sync.
...
| Azure AD | ✅ Fully Tested | [Setup Guide](/authentication/saml-sso-azure) |
| Keycloak | ✅ Fully Tested | [Setup Guide](/authentication/saml-sso-keycloak) |
| Google Workspace | ✅ Supported | [Setup Guide](/authentication/saml-sso-google) |
| Auth0 | ✅ Supported | Use generic SAML 2.0 setup |
| OneLogin | ✅ Supported | Use generic SAML 2.0 setup |
| Other SAML 2.0 providers | ✅ Supported | Use generic SAML 2.0 setup |
...
- **[Integration Examples](/authentication/saml-sso-integration)** - Detailed code examples for React, Next.js, Vue.js
- **[Assign Roles](/how-to/assign-roles)** - Give SSO users appropriate access
- **[Audit Logs](/how-to/audit-logs)** - Monitor SSO activity
