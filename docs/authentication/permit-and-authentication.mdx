...
description: "Learn how authentication and authorization work together with Permit.io, including user sync and role management approaches."
...
When it comes to AuthN, Permit.io provides the flexibility to:
