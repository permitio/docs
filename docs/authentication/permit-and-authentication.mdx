...
:::tip TL;DR
- [Authentication establishes identity; Authorization defines access.](#what-is-authentication--why-it-matters)
...
- Permit.io [Supports SCIM](/integrations/scim/scim%20overview/), [API-based sync](/how-to/sync-users), [JWT attribute passing](/authentication/your-authentication), and [dynamic direct policy checks](/how-to/enforce-permissions/check#just-in-time-jit-attributes).
:::
