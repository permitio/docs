...
description: "Integrate Logto authentication with Permit.io in a Next.js app, syncing users by webhook and checking permissions in the UI."
...
Logto is an identity solution designed for secure authentication. This guide will show you how to integrate it into your [Permit.io](https://www.permit.io) implementation to create a complete authentication and authorization system for your Next.js application.
...
## What You'll Build
In this tutorial, you'll learn how to integrate Logto with [Permit.io](https://www.permit.io/) to:
-   Authenticate users with Logto
-   Automatically sync users to [Permit.io](https://www.permit.io/) upon registration
...
-   A [Permit.io](https://www.permit.io/) account (sign up at [permit.io](https://www.permit.io/))
...
### Set Up Authorization in [Permit.io](https://www.permit.io)

Before implementing the integration, set up your authorization structure in [Permit.io](https://www.permit.io):

> To get started with [Permit.io](https://www.permit.io), refer to their [Quickstart guide](/quickstart). This guide provides step-by-step instructions for setting up a workspace, defining roles and resources, and assigning permissions to roles.

1.  Sign up or log in to your [Permit.io](https://www.permit.io/) account
...
Creating policies in [Permit.io](https://www.permit.io)

</TimelineStep>
<TimelineStep>

### Create the [Permit.io](https://www.permit.io) Integration

Create a file for [Permit.io](https://www.permit.io) integration:
...
3.  After signing in, check the [Permit.io](https://www.permit.io) dashboard to verify that your user has been synced and assigned the correct role
...
Logto Users Synced to [Permit.io](https://www.permit.io) with Role Assignments

</TimelineStep>
</TimelineWrapper>

### Using [Permit.io](https://www.permit.io) in Your Application Logic

Now that you've set up the integration, you can use [Permit.io](https://www.permit.io)'s permission checks throughout your application:
...
You've successfully integrated Logto for authentication with [Permit.io](https://www.permit.io) for authorization in your Next.js application. This combination provides:

1.  **Seamless user authentication** through Logto
2.  **Automatic user synchronization** to [Permit.io](https://www.permit.io)
...
-   Multi-tenancy support in [Permit.io](https://www.permit.io)
-   Attribute-based access control (ABAC)
-   Role inheritance and hierarchies
-   Custom permission checks based on user attributes

If you need help, reach out through the [Permit.io](https://www.permit.io) [Slack Community](https://io.permit.io/docs-to-slack) or Logto's [Discord server](https://discord.com/invite/UEPaF3j5e6).