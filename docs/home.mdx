...
<PagePadding>
  <PageVerticalPadding>
    <Container isGrid>
      ...
      <Hr title="Authorization & Access Control" color="#974ef2" />
      ...
      <Hr title="Enforcement & Integrations" color="#E67E22" />
      <DocCardList articleClassName={"col"} items={enforcementRow} />
      <Hr title="DevOps & Customization" color="#16A085" />
      <DocCardList articleClassName={"col"} items={devOpsRow} />
      <Hr title="Ask for help & Read More" color="#846358" />
