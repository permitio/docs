...
If you would like to learn more about creating conditions, please refer to **[Available Conditions](/2.0.0/api/working-with-abac/conditions)**.
...
![Resource Set Example](/img/abac/resource-set-0.png)
