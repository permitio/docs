...
A relationship specifies the subject first, the relation second and the object third: `(subject, relation, object)`
...
Role assignments are a special type of relationship where:
...
Let's start by creating the Account resource type, which represents an organization's account in Google Drive. In the next section, we'll create a specific instance of this resource type for our fictional company, ACME, Inc.
