...
import CodeBlockComponent from "@site/src/components/elements/CodeBlockComponent.js";
...
<CodeDropdown number="3.2" title="Using Bearer Token" server code={code.bearer}>
