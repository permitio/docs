...
### Setting up User Management Element
After setting up your email provider and templates, you can now use the **[User Management Element](/features/permit-elements/element/user-management)** to invite and approve new end users.
...
You can do this using the SDK of your choice, for example, using the **[Python SDK](/sdks/python/quickstart-python)**:
```python
