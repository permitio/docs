...
If you want to get early access please [join our Slack community](https://io.permit.io/join_community) and join the [#frontend-only-authz](https://permit-io.slack.com/archives/C04U83ZABRD) channel.
