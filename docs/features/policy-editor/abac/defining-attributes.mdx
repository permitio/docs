...
After [creating the attribute definintions](/features/policy-editor/abac/building-abac-policy#create-tenant-attributes), you can define tenant-specific attributes.
