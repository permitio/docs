...
description: "Run a demo application that connects to Permit.io and enforces access based on user roles, in your language of choice."
---

Connect a demo application to Permit.io and enforce access with the SDK.
By the end, you have a running application that allows or denies each request based on the user's role.
