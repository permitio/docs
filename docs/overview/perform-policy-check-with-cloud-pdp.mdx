...
object**, and calling the **check function**.

These steps allow you to programmatically verify access decisions and integrate them into
your application seamlessly. You can refer back to all these steps in our [previous walkthrough](/overview/use-the-permit-api-and-sdk).
...
<WhatsNext progress={80} customText="Fourth step done!" />
