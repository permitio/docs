...
## Getting the project and environment id
...
`environment ID`, which are required for your requests. To learn how to obtain these IDs, refer to the mini-guides provided below.

- Get your **[project id](/manage-your-account/projects-and-env#getting-the-project-id)**
- Get your **[environment id](/manage-your-account/projects-and-env#managing-access-to-a-project)**
...
<WhatsNext progress={60} customText="Third step done!" />
