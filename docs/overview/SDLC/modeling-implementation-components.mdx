...
:::info
Behind the scenes, Permit creates a Policy as Code repository for each project, and environments are branches in this repository. You can control these repositories yourself using the [GitOps feature](https://docs.permit.io/integrations/gitops/overview).
:::
