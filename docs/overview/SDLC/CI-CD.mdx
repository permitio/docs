...
using [projects and environments](https://docs.permit.io/manage-your-account/projects-and-env)
...
(via their [API secret key](https://docs.permit.io/manage-your-account/projects-and-env#fetching-and-rotating-the-api-key)).
...
We achieve this by allowing you to automatically map branches when you [connect your Permit Project to a repository](https://docs.permit.io/integrations/gitops/github),
