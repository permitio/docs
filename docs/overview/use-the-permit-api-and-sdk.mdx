...
You will need your API key, which you can obtain from the Permit dashboard. We have a whole [guide](/overview/sync-your-first-user-with-sdk#obtain-your-api-key) for this.
