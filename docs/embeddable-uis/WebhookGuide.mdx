...
This guide will help you configure webhooks for your Permit Elements. Webhooks are automated messages sent from apps when something happens.
They carry data in 'payloads', which are sent to a unique URL, essentially a place where your API can accept data.
