...
- Configure Webhooks to receive automatic updates on actions taken by your users.
  For more information about Webhooks, you can read the [Permit Webhooks](/embeddable-uis/element/user-management/#configure-your-webhook) documentation.
...
To view more information about the other login methods, you can read the [Permit Elements Login Methods](/embeddable-uis/element/user-management/#server-side-login-route) documentation.
...
For more information about the JWKS configuration, you can read the [Permit JWKS Configuration](/foaz/fetching-jwks/#what-are-jwks) documentation.
