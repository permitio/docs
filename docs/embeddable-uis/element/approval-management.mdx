...
The Approval Management Element allows users with role "Operation Approval Reviewer" to manage pending requests efficiently. The element displays a list of pending requests, and the reviewer can approve or deny them. The element is designed to be embedded in your application, and it is fully customizable to fit your application's look and feel.
...
:::note
We manage a list of users from the Operation Approval element. You can learn about and implement the element on this page.
:::
