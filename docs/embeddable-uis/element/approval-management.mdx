...
<img src="/img/approval-flows/approval-management.png" alt="approval-management-element" style={{width:'70%',border:'1px solid black'}}/>
</span>


## Overview

The Approval Management Element allows users with an Approver role to manage pending requests. Approver roles are assigned.
...
![create-approval-management](/img/approval-flows/approval-m-inelement-screen.png)


### 2. Give the element a name, and click on "Create".

![create-approval-management](/img/approval-flows/approval-management-with-setting.png)
