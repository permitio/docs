...
The Approval Process API allows to create approval requests for specific action in your application. It also assigns relevant moderators to approve or deny user requests based on your decision.
...
You can filter approval processs by passing the following headers:
