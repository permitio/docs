...
### Embedding the Element
This element consists of two parts, the first part is the user management and the second part is in the access request element.


### User Management Element
You must create and configure the user management element and save it.

NOTE: It is important to define roles and choose a tenant.
...
Before choose user management element, you must connect the user management element to the access request element.
...
Note: It is important to choose your tenant.
