---
sidebar_position: 2
title: Access Requests Element-API
---
...
# Access Requests Element-API

<span className="subtitle-custom">
	Let your users ask for access request to your application and manage the existing requests.
</span>
<br />
<br />
