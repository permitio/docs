...
Permit.io Email Configuration and Templates allow you to seamlessly integrate Elements features into a SMTP Email provider.
This enables you to automatically send notifications and action controls to end users using SMTP email provider.
...
In the Element Settings Screen you will see a menu with the SMTP email provider.
