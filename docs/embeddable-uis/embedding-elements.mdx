...
To help you get started, we have created an [example project](https://github.com/permitio/permit-demo-element?tab=readme-ov-file#getting-started-with-create-react-app) that demonstrates how to embed Permit Elements into your application 🚀.
...
- Configure webhooks to receive automatic updates on actions taken by your users. For more information about webhooks, refer to
  the [Permit Webhooks documentation](/embeddable-uis/element/user-management/#configure-your-webhook).
