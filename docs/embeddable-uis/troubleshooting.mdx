...
In most cases, the error message will give you a hint about what is wrong - for more information, check the [Login Errors](/embeddable-uis/element-login#login-errors) section in Login Methods page.