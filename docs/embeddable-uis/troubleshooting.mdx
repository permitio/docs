...
- Make sure you implement the login method correctly both in your **frontend** and **server** applications - follow the [Login Methods](/docs/elements/login-methods) guide to make sure that the login method is implemented correctly.
...
Read more about the supported login methods [here](/docs/elements/login-methods).
...
Make sure that the login method is implemented correctly in your frontend and server applications - follow the [Login Methods](/docs/elements/login-methods) guide to make sure that the login method is implemented correctly.
...
In most cases, the error message will give you a hint about what is wrong - for more information, check the [Login Errors](/docs/elements/login-methods) section in Login Methods page.
...
Follow the [Login Methods](/docs/elements/login-methods) guide to make sure that the login method is implemented correctly.
:::
