...
Hi 👋, if you're here you have probably successfully [completed the onboarding guide](/getting-started/create-your-account/), connected your application with Permit and checked for Permissions.
