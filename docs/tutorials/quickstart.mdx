...
<img src={https://i.postimg.cc/7hvpTFzc/Copy-secret-key.png} alt="Copy Secret Key" />

Or: 
Click on your user icon at the top right of the screen and click there "Copy SDK secret key".
<img src={https://i.postimg.cc/y8MY78Y4/Copy-secret-key-2.png} alt="Copy Secret Key" />
