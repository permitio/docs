...
solution (such as Auth0, AWS Cognito, Firebase, [FusionAuth](https://fusionauth.link/4fS8uTU), Stytch, Magic, or even your own custom solution) to the permit.check()
function.
