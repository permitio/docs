...
Permit.io, being an **[authorization solution](/overview/permit-basics)**, naturally requires integration with your authentication
...
solution (such as Auth0, AWS Cognito, Firebase, FusionAuth, Stych, Magic, or even your own custom solution) to the permit.check()
function.
