    ...
    class HttpServer
    {
        ...
        public static async Task HandleIncomingConnections()
        {
            ...
            while (runServer)
            {
                ...
                UserKey user = new UserKey("dbfd1bfc-e5df-4930-b364-aa5d2d111bce", "Raz", "Cohen", "raz@permit.io");
                // init Permit SDK
                string clientToken = "permit_key_LPYmx59tGMnBwtYzq6o12NiLtkv4lGmJjokLW0DiC0yQh6QIZoEngmdABugBySV2NddS0HOShhP6DahsWTkGbi";
                Permit permit = new Permit(
                    clientToken,
                    "http://localhost:7766",
                    "default",
