...
#### 2. Get the Permit.io PDP API key

Navigate to the **[Project Management](https://app.permit.io/projects)** page with the **Permit.io** web interface.
Find the environment that you wish to connect to and click on its context menu, then select **Copy API Key**.
...
"**Copy SDK API Key**" from there (this API will connect you to the active environment inside Permit).
