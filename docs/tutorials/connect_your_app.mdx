...
import PythonConnect from '@site/docs/reference/SDKs/Python/get_roles.mdx';
...
In the app, each user that signs in should have a unique identifier - such as a user-id / email / Auth0Id / CognitoId / etc.
