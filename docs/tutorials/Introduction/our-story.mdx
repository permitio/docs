...
Interacting with CISOs (Chief Executive Security Officers), they quickly learned that while they deeply care about the problem, 
they are not the ones making the de facto decisions here, but rather developers, who are the ones setting the tone.
