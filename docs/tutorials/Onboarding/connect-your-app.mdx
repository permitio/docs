...
Or you can use the **[SyncResources](../../SDKs/Dotnet/sync_resources)** SDK function.

<br />

### List tenants

To get the available tenants, you can use the following **[API Call](../../api/api_with_cli#get-all-tenants)**.
