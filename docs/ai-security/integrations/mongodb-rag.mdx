...
6. Query the API as `user_engineering_1`, a member of engineering:
   ...
   `user_engineering_1` gets an answer from `docs/engineering/api_design.md`. `user_marketing_1`, a member of marketing, doesn't get content from that document.
