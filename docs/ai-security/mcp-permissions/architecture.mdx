...
2. **Medium trust** — write operations (`create_*`, `write_*`, `update_*`, `set_*`, `modify_*`, `edit_*`, `put_*`, `post_*`, `insert_*`, `add_*`, `send_*`, `execute_*`, `run_*`, `invoke_*`, `submit_*`, `push_*`, `publish_*`, `deploy_*`, `apply_*`, `patch_*`)
3. **High trust** — destructive operations (`delete_*`, `remove_*`, `destroy_*`, `drop_*`, `purge_*`, `erase_*`, `truncate_*`, `terminate_*`, `kill_*`, `revoke_*`)
