...
| ----------- | -------- | ------------ |
| **Soft expiry** | 30 days of inactivity | If no tool calls are made for 30 days, the session expires. The user must re-consent to create a new session. |
| **Hard expiry** | 90 days total | Regardless of activity, sessions expire after 90 days. The user must re-consent. |
