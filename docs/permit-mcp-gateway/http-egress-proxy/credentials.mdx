...
You configure AWS request signing in the [dashboard](https://app.agent.security) under **Proxy → Credentials** as an AWS credential, then reference it from a workflow rule for the relevant AWS host(s) like any other credential.
