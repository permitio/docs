...
A walkthrough demonstrating how to set up Permit MCP Gateway so that users with different trust levels are limited in what they can do with their Linear MCP tools.
