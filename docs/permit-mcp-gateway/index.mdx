...
- [**HTTP Egress Proxy**](/permit-mcp-gateway/http-egress-proxy/): govern an agent's outbound HTTP and HTTPS API calls, not only its MCP tools
...
- [**Enterprise Deployment**](/permit-mcp-gateway/enterprise-deployment): customer-controlled and on-premises deployment for regulated environments and data residency
