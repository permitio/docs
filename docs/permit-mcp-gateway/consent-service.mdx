...
After signing in, the consent screen shows a list of MCP servers the admin has [granted the user access to](/permit-mcp-gateway/guide#4-grant-user-access-to-mcp-servers). The user selects the server they want to connect to from this pre-approved list — they cannot enter an arbitrary URL.
