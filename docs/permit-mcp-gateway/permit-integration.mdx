...
Permit MCP Gateway uses [Permit.io](https://www.permit.io) as its **policy engine** — every authorization decision for every tool call is evaluated by Permit. This isn't a loose integration; Permit is the core of how permissions are modeled, enforced, and audited.
