...
- Sessions persist across client restarts. A session expires 90 days after the last tool call. See [Session expiry](/permit-mcp-gateway/consent-service#session-expiry).
