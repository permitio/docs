...
description: Explore Agent Security's advanced Enterprise capabilities — time-limited consent and more.
sidebar_position: 4
---
...
The consent flow enforces a **90-day hard expiration** (consent is fully revoked) and a **30-day soft expiration** (user is prompted to re-confirm).
:::
...
{/* ============================================================
    HIDDEN — Preserved for future use when these features ship.
    TODO: When uncommenting any section below, review and update
    the content to reflect the actual implementation — these were
    written as aspirational descriptions and may not match what
    was actually built.
    ============================================================
