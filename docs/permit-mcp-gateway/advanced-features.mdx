...
The gateway already enforces a **90-day hard session expiry** and a **30-day soft (inactivity) expiry** on all plans — see [Consent Service: Session expiry](/permit-mcp-gateway/consent-service#session-expiry). The Enterprise feature below adds **configurable consent windows** (e.g., 2-week access for contractors) beyond these defaults.
:::
...
Want to learn more about our Enterprise capabilities? Get in touch:
