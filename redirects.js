...
// Extracted from docusaurus.config.js so route-inventory.mjs and checkRedirects.js
...
module.exports = [
  {
    ...
    // @docusaurus/theme-search-algolia. Removing that unused theme (Inkeep
    // is the site's actual search/chat UI and never linked to /search) means
