...
export const enforcementRow = [
  {
    ...
    svgIcon: <i className="ri-user-settings-line ri-xl !text-pm-purple"></i>,
  ...
  },
  {
    ...
    svgIcon: <i className="ri-shield-line ri-xl !text-pm-purple"></i>,
  ...
  },
  {
    ...
    svgIcon: <i className="ri-stack-line ri-xl !text-pm-purple"></i>,
  ...
  },
  {
    ...
    label: "URL Mapping",
    svgIcon: <i className="ri-map-pin-line ri-xl !text-pm-purple"></i>,
...
export const socialsRow = [
  {
    ...
    svgIcon: <i className="ri-slack-line ri-xl !text-pm-text-muted"></i>,
  },
  {
    type: "link",
    href: "https://github.com/permitio",
    label: "Github",
    svgIcon: <i className="ri-github-line ri-xl !text-pm-text-muted"></i>,
  },
];
