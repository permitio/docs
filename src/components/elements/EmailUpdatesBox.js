  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="flex flex-col items-center bg-slate-100 dark:bg-slate-300 mt-8 rounded px-20 py-6 h-60 justify-center">
        {success ? (
          <>
            <span className="text-2xl font-semibold text-blue-900">Thanks for signing up!</span>
          ...
          <>
            ...
            <span className="mt-4 dark:text-slate-900">
              Provide your email to receive early access to eligible beta features for Permit
              Elements.
            </span>
