...
Don't see logs? Use the **[troubleshooting](/1.0.0/features/Audit%20Logs/troubleshooting)** page to find reasons why.
:::

<br />

:::note
Looking for another platform? Check the [SDK overview](/1.0.0/sdk/sdks-overview) for the most up-to-date list of supported languages and frameworks.
:::
