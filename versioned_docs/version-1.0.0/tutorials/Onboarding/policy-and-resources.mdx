...
A resource is the target object we want to authorize access too. We can also refer to them as the ***objects*** of
...
![Onboarding Introduction](/img/onboarding/3.png)
...
![Onboarding Introduction](/img/onboarding/4.png)