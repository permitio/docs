...
OPAL's built-in [separation of the data plane from the control plane](/concepts/control_plane_and_data_plane), enables Permit.io users to enjoy the benefits of a fully distributed PDP solution, without having to be dependant on the availability of the Permit.io cloud, or sharing any data with it.
