...
The main component which enables the hybrid architecture is the [PDP (Policy Decision Point)](/concepts/pdp/overview).
...
Read more about [the Permit.io PDP here](/concepts/pdp/overview).
