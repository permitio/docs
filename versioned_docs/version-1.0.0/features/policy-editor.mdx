...
Roles are assigned to users in the **[User Management](/1.0.0/features/user-management)** page.
...
Permit.io supports multiple authorization models - including **RBAC** (**_Role Based Access Control_**), **ABAC** (**_Attribute Based Access Control_**) and more.
...
or **[send us a message](https://io.permit.io/docs-to-slack)** on **Slack**, and we will enable it for you.
