...
Via the **[User Management](https://app.permit.io/user-management)** web interface you can control your **[users](/1.0.0/features/user-management#users)** -
...
The tenant feature we enable you to have multi-tenancy straight out of the box.
